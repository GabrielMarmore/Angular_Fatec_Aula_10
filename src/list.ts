export const ListEmenta = [
  ...
  },
  {
    id: 3,
    ementa:
      'Aprimoramento da compreensão e produção oral e escrita por meio da integração das habilidades linguístico-comunicativas. Ênfase na oralidade, atendendo às especificidades acadêmico-profissionais da área e abordando aspectos socioculturais da língua inglesa.',
  },
  {
    id: 4,
    ementa:
  ...
  { id: 6, ementa: 'Recursos e aplicações da tecnologia escolhida' },
  {
    id: 6,
    ementa:
